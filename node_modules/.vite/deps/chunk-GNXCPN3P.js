...
var React6, import_react, isBrowser2, hasOwn, EmotionCacheContext, CacheProvider, withEmotionCache, ThemeContext, getTheme, createCacheWithTheme, typePropName, labelPropName, Insertion, Emotion;
      ...
      withEmotionCache = function withEmotionCache3(func) {
        return function(props) {
          ...
          if (cache2 === null) {
            ...
            return React6.createElement(EmotionCacheContext.Provider, {
              value: cache2
            }, func(props, cache2));
          } else {
...
var React7, import_hoist_non_react_statics2, pkg, warnedAboutCssPropForGlobal, Global, keyframes, classnames, Insertion3, ClassNames, isBrowser3, isTestEnv, globalContext, globalKey;
  ...
  "node_modules/@emotion/react/dist/emotion-react.browser.esm.js"() {
    ...
    Global = withEmotionCache(function(props, cache2) {
      ...
      if (!isBrowser2) {
        ...
        return React7.createElement("style", (_ref = {}, _ref["data-emotion"] = cache2.key + "-global " + serializedNames, _ref.dangerouslySetInnerHTML = {
          __html: rules
...
var React8, testOmitPropsOnStringTag, testOmitPropsOnComponent, getDefaultShouldForwardProp, composeShouldForwardProps, ILLEGAL_ESCAPE_SEQUENCE_ERROR2, Insertion5, createStyled;
...
var React9, import_prop_types, import_jsx_runtime2, cache;
...
var React10, import_prop_types2, import_jsx_runtime3;
...
function ThemeProvider4(_ref) {
  ...
  return (0, import_jsx_runtime16.jsx)(ThemeProvider_default2, _extends({}, props, {
...
function SeriesContextProvider(props) {
  ...
  return (0, import_jsx_runtime18.jsx)(SeriesContext.Provider, {
...
function value_default(a2, b) {
  var t = typeof b, c6;
  return b == null || t === "boolean" ? constant_default(b) : (t === "number" ? number_default : t === "string" ? (c6 = color2(b)) ? (b = c6, rgb_default) : string_default : b instanceof color2 ? rgb_default : b instanceof Date ? date_default : isNumberArray(b) ? numberArray_default : Array.isArray(b) ? genericArray : typeof b.valueOf !== "function" && typeof b.toString !== "function" || isNaN(b) ? object_default : number_default)(a2, b);
}
...
function locale_default(locale3) {
  ...
  function newFormat(specifier) {
    ...
    function format2(value) {
      var valuePrefix = prefix4, valueSuffix = suffix, i, n, c6;
      if (type === "c") {
  ...
  function formatPrefix2(specifier, value) {
    var f = newFormat((specifier = formatSpecifier(specifier), specifier.type = "f", specifier)), e = Math.max(-8, Math.min(8, Math.floor(exponent_default(value) / 3))) * 3, k2 = Math.pow(10, -e), prefix4 = prefixes[8 + e / 3];
...
function formatLocale(locale3) {
  ...
  function parseSpecifier(d, specifier, string, j) {
    var i = 0, n = specifier.length, m = string.length, c6, parse2;
    while (i < n) {
      if (j >= m) return -1;
...
function CartesianContextProvider(props) {
  ...
  const xAxis = React44.useMemo(() => normalizeAxis(inXAxis, dataset, "x"), [inXAxis, dataset]);
  const yAxis = React44.useMemo(() => normalizeAxis(inYAxis, dataset, "y"), [inYAxis, dataset]);
  const xValues = React44.useMemo(() => computeValue(drawingArea, formattedSeries, xAxis, xExtremumGetters, "x"), [drawingArea, formattedSeries, xAxis, xExtremumGetters]);
  const yValues = React44.useMemo(() => computeValue(drawingArea, formattedSeries, yAxis, yExtremumGetters, "y"), [drawingArea, formattedSeries, yAxis, yExtremumGetters]);
  ...
  return (0, import_jsx_runtime19.jsx)(CartesianContext.Provider, {
    value,
    children
  });
}
...
// node_modules/@mui/x-charts/esm/context/CartesianProvider/index.js
var cartesianProviderUtils = {
  computeValue,
  normalizeAxis
};
...
var ZAxisContext = React46.createContext({
  zAxis: {},
  zAxisIds: []
});
if (true) {
...
function ZAxisContextProvider(props) {
  ...
  const zAxis = React46.useMemo(() => inZAxis == null ? void 0 : inZAxis.map((axisConfig) => {
    const dataKey = axisConfig.dataKey;
    if (dataKey === void 0 || axisConfig.data !== void 0) {
      return axisConfig;
    }
  ...
  return (0, import_jsx_runtime20.jsx)(ZAxisContext.Provider, {
    value,
    children
  });
}
...
function useChartId() {
  ...
  return React47.useMemo(() => chartId, [chartId]);
}
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime21.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime21.jsxs)(React50.Fragment, {
...
function useChartGradient() {
  ...
  return React52.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
...
var useChartContainerDimensions = (inWidth, inHeight) => {
  ...
  const displayError = React53.useRef(false);
  const [width2, setWidth] = React53.useState(0);
  const [height2, setHeight] = React53.useState(0);
  const computeSize = React53.useCallback(() => {
...
function useSprings(length2, props, deps) {
  ...
  if (propsFn && !deps)
    deps = [];
  const ref = (0, import_react17.useMemo)(
    () => propsFn || arguments.length == 3 ? SpringRef() : void 0,
    []
  );
  const layoutId = (0, import_react17.useRef)(0);
  const forceUpdate = useForceUpdate();
  const state = (0, import_react17.useMemo)(
    () => ({
      ctrls: [],
      queue: [],
      flush(ctrl, updates2) {
  ...
  const ctrls = (0, import_react17.useRef)([...state.ctrls]);
  const updates = [];
  ...
  const context = (0, import_react17.useContext)(SpringContext);
...
isUnitlessNumber = Object.keys(isUnitlessNumber).reduce((acc, prop) => {
  prefixes2.forEach((prefix4) => acc[prefixKey(prefix4, prop)] = acc[prop]);
  return acc;
}, isUnitlessNumber);
...
function InteractionProvider(props) {
  ...
  return (0, import_jsx_runtime24.jsx)(InteractionContext.Provider, {
    value,
    children
  });
}
...
var _excluded18 = ["highlighted", "faded"];
var mergeDeprecatedOptions = (options) => {
  const _ref = options ?? {}, {
    highlighted,
    faded
  } = _ref, rest = _objectWithoutPropertiesLoose(_ref, _excluded18);
  return _extends({
...
var useChartContainerHooks = (ref, plugins) => {
  const svgRef = React62.useRef(null);
...
var ColorContext = React63.createContext({});
if (true) {
...
function ColorProvider(props) {
  ...
  return (0, import_jsx_runtime26.jsx)(ColorContext.Provider, {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-GNXCPN3P.js.map
